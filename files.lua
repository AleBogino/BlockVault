...
files.shared = {{
    path = "shared/cannonical.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/cannonical.lua"
}, {
    path = "shared/constants.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/constants.lua"
}, {
    path = "shared/crypto.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/crypto.lua"
}, {
    ...
    path = "shared/serialization.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/serialization.lua"
}, {
    path = "shared/session.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/session.lua"
}, {
    path = "shared/signing.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/signing.lua"
}, {
    path = "shared/utils.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/utils.lua"
}, {
    path = "shared/player_detector.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/shared/player_detector.lua"
}}

files.server = {{
    path = "server/accounts.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/server/accounts.lua"
}, {
    ...
    path = "server/logger.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/server/logger.lua"
}, {
...
files.client = {{
    ...
    path = "client/network.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/client/network.lua"
}, {
    path = "client/protocol.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/client/protocol.lua"
}, {
    path = "client/setup.lua",
    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/client/setup.lua"
}, {
    path = "client/ui.lua",
