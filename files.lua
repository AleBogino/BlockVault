...
files.server = {
    ...
    { path = "server/master.lua",         url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/server/master.lua"         },
...
files.client = {
    ...
    { path = "client/master.lua",    url = "https://raw.githubusercontent.com/alebogino/BlockVault/master/client/master.lua"    },
